...
def Create_Material_Data(model,material_name,e11,e22,e33,nu12,nu13,nu23,g12,g13,g23,lts,lcs,tts,tcs,lss,tss,rho):
...
def Create_Modal_Analysis(model,step_name,pre_step_name):
    mdb.models[model].FrequencyStep(name=step_name, previous=pre_step_name, simLinearDynamics=OFF, normalization=MASS, numEigen=10, vectors=18, maxIterations=3000, eigensolver=SUBSPACE, acousticCoupling=AC_OFF)
...
Create_Material_Data(myString,"CFRP",myE11,myE22,myE33,myNu12,myNu13,myNu23,myG12,myG13,myG23,myLTS,myLCS,myTTS,myTCS,myLSS,myTSS,myDensity)
...
Create_Modal_Analysis(myString,"Step-1","Initial")
