...
myString = "Buckling_Analysis_GFRP"
...
Create_Material_Data(myString,"GFRP",myE11,myE22,myE33,myNu12,myNu13,myNu23,myG12,myG13,myG23,myLTS,myLCS,myTTS,myTCS,myLSS,myTSS)
...
Create_Pressure_Load(myString,"Cylinder-1","Internal_Pressure","Step-1","Internal_Surface",1)



Create_Composite_Layup(myString,myPart,"Cylinder_3D","Quasi_Isotropic",myPlyNumber,"GFRP",myThickness/myPlyNumber,myAngle)
...
CreateJob(myString,"GFRP_Cylinder",8)

# SubmitJob("GFRP_Cylinder")
